    ...
    const submitPet = async (formVals) => {
        const formattedData = {
            fields: {
                ...
                breed: { stringValue: formVals.breed },
                age: { stringValue: formVals.age },
                name: { stringValue: formVals.name },
                petType: { stringValue: formVals.petType },
                image: { stringValue: formVals.image },
                isAdopted: { booleanValue: false },
            }
        }
    ...
    return (
        <div className="pets-page">
            <form className="form-layout" onSubmit={handleSubmit(submitPet)}>
                ...
                <input type="submit" values="Submit Pet"/>
                <br/>
            </form>
        </div>
    );
